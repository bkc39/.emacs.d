;;; setup-clojure.el --- Customizations for Clojure
;;; Commentary:
;;;   Customizations to Clojure mode
...
(defun cider-start-http-server ()
  "Start a cider Http server with the current buffer loaded."
  (interactive)
...
(defun cider-user-ns ()
  "Switch cider to the user namespace."
  (interactive)
